export const experience = [
  {
    ...
    description:
      "Currently volunteering as a web developer for the Scottish Tech Army, working with a team to create a wordpress website that will offer valuable community services for their client's users.",
  },
  {
    id: crypto.randomUUID(),
